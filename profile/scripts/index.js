...
class AboutMe extends React.Component{
  ...
  render(){
    ...
    let svg = React.createElement('svg', {className: 'svg', id:'github', viewBox: '0 0 24 24'}, path);
    ...
    svg = React.createElement('svg', {className: 'svg', id:'linkedIn', viewBox: '0 0 24 24'}, path);
...
class App extends React.Component{
  ...
  // Renders homepage
  renderHomePage() {
    let homepage = React.createElement('div', {className: 'home-page'}, navbar, header, slideshow, footer);
    return homepage;
  }

  // Render about page
  renderAboutPage() {
    let homepage = React.createElement('div', {className: 'about-page'}, navbar, header, aboutMe, footer);
    return homepage;
  }
